...
The new description for the FileSet
  ...
  [FileSet API (BETA)](#fileset-api-beta "FileSet API (BETA)")[Get File by Path](#get-file-by-path "Get File by Path")[Get File by Id](#get-file-by-id "Get File by Id")[Download File by Id](#download-file-by-id "Download File by Id")[Query Files](#query-files "Query Files")[Upload File](#upload-file "Upload File")[Search Files in FileSet](#search-files-in-fileset "Search Files in FileSet")[Delete Files by Path](#delete-files-by-path "Delete Files by Path")[Delete File by Id](#delete-file-by-id "Delete File by Id")[Search FileSets](#search-filesets "Search FileSets")[Create FileSet](#create-fileset "Create FileSet")[Get FileSet by Id](#get-fileset-by-id "Get FileSet by Id")[Update FileSet by Id](#update-fileset-by-id "Update FileSet by Id")[Delete FileSet by Id](#delete-fileset-by-id "Delete FileSet by Id")
